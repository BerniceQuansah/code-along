...
console.log(data);
    ...
    return(
        <div className="h-screen bg-gradient-to-br from-red-600 to-blue-500 flex justify-center items-center">
            ...
            <form>
                ...
                name="email"
                id="email"
                placeholder="abena.agyeiwaa@gmail.com" value={data.email}  onChange={handleChange}/>   
              </div>
